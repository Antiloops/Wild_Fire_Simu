...
public class Terrain {
    ...
    //Méthode initialisant un tableau de dimension longueur x largeur dans lequel on fixe l'humidité de chaque case
    ...
    //Methode permettant d'initialiser la végétation du terrain
